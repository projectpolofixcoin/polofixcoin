...
uint256 hashGenesisBlock("0xdb9573be12d51ce3fc0a4a30b3e0c08115979a3959e65b9feb95e9bb980e282b");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Polofixcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Polofixcoin Signed Message:\n";
...
{
    // Polofixcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 15000000); // Polofixcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Polofixcoin: 3.5 days
static const int64 nTargetSpacing = 120; // Polofixcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Polofixcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Polofixcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Polofixcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7f47f3735f5f3cf2e6105901083857202c66098279e898d5e0c99422516098e5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("9954eff9c0b1811caab532044f15c9cbf90aa8947385899b57337124e4f8e9e35468d7c3780a26fd97f34ac9c981c96c2e1f388cd454baa8fb4d55835ee0766306") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1519302073;
        block.nBits    = 504365644;
        block.nNonce   = 1859656043;

        if (fTestNet)
        {
            block.nTime    = 1519302073;
            block.nNonce   = 164224140;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x19171a23b9cd65013e39fbbb7cc3a5af7e1e4aec72712ddb96c100f7f13c7082"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Polofixcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PolofixcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PolofixcoinMiner : ProcessBlock, block not accepted");
    }
